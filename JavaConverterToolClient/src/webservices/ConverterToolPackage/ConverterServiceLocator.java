...
public class ConverterServiceLocator extends org.apache.axis.client.Service implements webservices.ConverterToolPackage.ConverterService {
    ...
    private java.lang.String Converter_address = "http://localhost:8080/JavaConverterTool/services/Converter";
    ...
    public webservices.ConverterToolPackage.Converter getConverter(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            webservices.ConverterToolPackage.ConverterSoapBindingStub _stub = new webservices.ConverterToolPackage.ConverterSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (webservices.ConverterToolPackage.Converter.class.isAssignableFrom(serviceEndpointInterface)) {
                webservices.ConverterToolPackage.ConverterSoapBindingStub _stub = new webservices.ConverterToolPackage.ConverterSoapBindingStub(new java.net.URL(Converter_address), this);
                _stub.setPortName(getConverterWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://ConverterToolPackage.webservices", "ConverterService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://ConverterToolPackage.webservices", "Converter"));
        }
